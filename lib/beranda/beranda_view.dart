...
class _BerandaPageState extends State<BerandaPage> {
  ...
  void initState() {
    ...
    _gojekServiceList.add(new GojekService(
        image: Icons.shopping_cart_checkout,
        color: GojekPalette.menuRide,
        title: "kebutuhan"));
    _gojekServiceList.add(new GojekService(
        image: Icons.woman, color: GojekPalette.menuCar, title: "fashion"));
    _gojekServiceList.add(new GojekService(
        image: Icons.man,
        color: GojekPalette.menuBluebird,
        title: "Pakaian Pria"));
    _gojekServiceList.add(new GojekService(
        image: Icons.restaurant, color: GojekPalette.menuFood, title: "FOOD"));
    _gojekServiceList.add(new GojekService(
        image: Icons.next_week, color: GojekPalette.menuSend, title: "SEND"));
    _gojekServiceList.add(new GojekService(
    ...
    _goFoodFeaturedList
        .add(new Food(title: "Hodie", image: "assets/images/baju1.jpg"));
    _goFoodFeaturedList
        .add(new Food(title: "Hodie", image: "assets/images/baju4.jpg"));
    _goFoodFeaturedList
        .add(new Food(title: "Tunik", image: "assets/images/baju3.jpg"));
    _goFoodFeaturedList
        .add(new Food(title: "shirt", image: "assets/images/baju5.jpg"));
    _goFoodFeaturedList
        .add(new Food(title: "Fashion pria", image: "assets/images/baju6.jpg"));
  }
    ...
    return new Container(
        ...
        decoration: new BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Color.fromARGB(255, 17, 199, 11),
                const Color.fromARGB(255, 17, 199, 11)
              ],
            ),
...
//                 child: new Column(
//                   children: <Widget>[
//                     _buildGopayMenu(), hahaha heheh huhu hemm hoho
// // method baru
//                     _buildGojekServicesMenu()
//                   ],
//                 )),
